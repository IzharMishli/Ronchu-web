...
var InstagramFeed = /*#__PURE__*/function (_Component) {
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    var url = "https://graph.instagram.com/me/media?fields=caption,media_count,media_type,permalink,media_url&&access_token=" + this.props.token;
  ...
  _proto.render = function render() {
    ...
    if (isError) {
      ...
      }, feeds.slice(0, this.props.counter)
      .filter((feed) => 
      {return String(feed.caption).includes("run")})
